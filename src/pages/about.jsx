...
function Test() {
  return (
    <div>
      <div className='bg-[#dedede] m-auto text-center pt-6'><h1 className='text-3xl font-bold'>About Me</h1></div>
      <div className='flex bg-[#dedede]'>
        <div className='flex px-10 pt-5 float-end'>
          ...
          <div className='p-10'>
            ...
            <p className='text-[#5e5e5e] pl-3'>I was born and raised in [Your Hometown]. Growing up, I developed a keen interest in technology and design, which led me to pursue a career in these fields. Currently, I am studying [Your Major or Field of Study] at [Your Educational Institution], and I have had the opportunity to work on various projects that have honed my skills in web development, graphic design, and video creation.</p>
